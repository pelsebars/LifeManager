...
export const P1_TASKS: Task[] = [
  // Phase 1
  {
    ...
    category: 'personal', dependencies: [], created_at: TS, updated_at: TS,
  },
  {
  ...
  },
  {
    ...
    dependencies: ['t1a', 't1b'], category: 'personal', created_at: TS, updated_at: TS,
  },
  // Phase 2
  {
  ...
  },
  {
    ...
    deadline: null, is_locked: false, progress_pct: 0, status: 'not_started',
    dependencies: ['t2a'], category: 'personal', created_at: TS, updated_at: TS,
  },
  {
    ...
    deadline: null, is_locked: false, progress_pct: 0, status: 'not_started',
    dependencies: ['t2b', 't2c'], category: 'personal', created_at: TS, updated_at: TS,
  },
  // Phase 3
  {
    ...
    deadline: null, is_locked: false, progress_pct: 0, status: 'not_started',
    dependencies: ['t2d'], category: 'personal', created_at: TS, updated_at: TS,
  },
  {
  ...
  },
  {
    ...
    dependencies: ['t3a', 't3b'], category: 'personal', created_at: TS, updated_at: TS,
  },
];
...
export const P2_TASKS: Task[] = [
  ...
  },
  {
    ...
    deadline: d(24), is_locked: true, progress_pct: 0, status: 'not_started',
    dependencies: ['t4a', 't4b'], category: 'personal', created_at: TS, updated_at: TS,
  },
  {
    ...
    deadline: null, is_locked: false, progress_pct: 0, status: 'not_started',
    dependencies: ['t5a'], category: 'personal', created_at: TS, updated_at: TS,
  },
  {
...
export const P3_TASKS: Task[] = [
  ...
  },
  {
    ...
    dependencies: ['t7b'], category: 'personal', created_at: TS, updated_at: TS,
  },
  {
    ...
    deadline: null, is_locked: false, progress_pct: 0, status: 'not_started',
    dependencies: ['t8a'], category: 'personal', created_at: TS, updated_at: TS,
  },
  {
  ...
  },
  {
    ...
    deadline: null, is_locked: false, progress_pct: 0, status: 'not_started',
    dependencies: ['t8b', 't8c', 't8d'], category: 'personal', created_at: TS, updated_at: TS,
  },
  {
    ...
    dependencies: ['t8e'], category: 'personal', created_at: TS, updated_at: TS,
  },
  {
    ...
    dependencies: ['t9a'], category: 'personal', created_at: TS, updated_at: TS,
  },
];
